...
export default function ServiceShow({ relatedServices = [], service }) {
    return (
        <>
            ...
            <div className="space-y-8">
                ...
                <section className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr]">
                    ...
                    <PublicCard className="p-6 md:p-8">
                        ...
                        <div className="mt-8 rounded-3xl border border-outline-variant bg-surface-container-low p-5">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 font-body-sm text-sm leading-6 text-on-surface-variant">Kirim preferensi waktu Anda. Admin Phoenix akan menghubungi via WhatsApp untuk memastikan jadwal final.</p>
                                </div>
                            </div>
                        </div>

                        <PrimaryLink className="mt-6 w-full" href={route('bookings.create', { service_id: service.id })}>
