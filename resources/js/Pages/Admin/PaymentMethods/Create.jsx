...
function AdminPaymentMethodsTambah() {
    const form = useForm({
        type: 'bank_transfer',
        bank_name: '',
        account_number: '',
        ...
        <>
            ...
            <div className="space-y-8">
                <AdminPageHeader
                    ...
                    description="Tambahkan metode pembayaran bank transfer atau QRIS tanpa mengubah alur pembayaran backend."
...
AdminPaymentMethodsTambah.layout = (page) => <AdminLayout>{page}</AdminLayout>;

export default AdminPaymentMethodsTambah;
