...
function deleteLeadSumber(leadSumber) {
    if (window.confirm(`Hapus lead source ${leadSumber.name}?`)) {
        router.delete(route('admin.lead-sources.destroy', leadSumber.id));
    }
}
