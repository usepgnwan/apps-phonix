...
function AdminProductKategoriTambah() {
    ...
    return (
        <>
            <Head title="Tambah Produk Kategori" />
            <div className="space-y-8">
                <AdminPageHeader
                    ...
                    description="Buat kategori baru untuk mengelompokkan produk Phoenix."
...
AdminProductKategoriTambah.layout = (page) => <AdminLayout>{page}</AdminLayout>;

export default AdminProductKategoriTambah;
