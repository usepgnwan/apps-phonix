...
function AdminOrderShow({ order }) {
    ...
    const statusUpdateMayProcessStock = orderOptions.includes('processing');
                ...
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
                    ...
                    <AdminCard className="p-5">
                        ...
                        <div className="space-y-3">
                            ...
                            <DetailRow label="Checkout Payment Method">{paymentMethodNama(order.payment_method)}</DetailRow>
                            <DetailRow label="Bank Account Number">{order.payment_method?.account_number ?? '-'}</DetailRow>
                            <DetailRow label="Account Holder Name">{order.payment_method?.account_holder_name ?? '-'}</DetailRow>
                            <DetailRow label="QRIS Image Path">{order.payment_method?.qris_image_path ?? '-'}</DetailRow>
                            <DetailRow label="Instruksi Pembayaran">{order.payment_method?.instructions ?? '-'}</DetailRow>
